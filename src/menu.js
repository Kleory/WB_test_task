(function () {
  ...
  const menuBgr = document.documentElement.querySelector(
    ".menu-mobileBackground"
  );
  ...
  const logoDescription =
    document.documentElement.querySelector(".logo-description");
  const headerWrapper =
    document.documentElement.querySelector(".header-wrapper");
